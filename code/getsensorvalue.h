...
*********************************************/
static float getSupplyVol(struct sensors_sensor * sensor) {
...
*		$SupplyVol: the voltage of supply.
*********************************************/
static float getBattVol(struct sensors_sensor * sensor) {
...
*********************************************/
static float getLight(struct sensors_sensor * sensor) {
...
*********************************************/
static float getTemp(struct sensors_sensor * sensor) {
